#ifndef GP_CONTROL_H_
#define GP_CONTROL_H_
...
public:
  ...
  //局部路径回调函数
  void recvGlobalPathCallback(const map_msgs::REFPointArray &msg);
  // AGV1.0 融合定位信息
...
protected:
  ...
  ////structs
  vector< positionConf > global_route_data_;
  ...
  double previous_endx;
  double previous_endy;
