...
void NormalKalmanFilter::predict()
{
#ifdef DEBUG_NORMAL_KALMAN_FILTER
...
void NormalKalmanFilter::updateFilterGain()
{
#ifdef DEBUG_NORMAL_KALMAN_FILTER
...
void NormalKalmanFilter::update(Eigen::VectorXf new_state, Eigen::MatrixXf measurement_cov, float detal_t)
{
#ifdef DEBUG_NORMAL_KALMAN_FILTER
...
void NormalKalmanFilter::setDetalTForTransitionMatrix(float detal_t)
{
#ifdef DEBUG_NORMAL_KALMAN_FILTER
