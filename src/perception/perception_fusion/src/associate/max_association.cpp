...
MaxAssociation::MaxAssociation(int cost_threshold)
    :BaseAssociation(cost_threshold)
{
}

MaxAssociation::~MaxAssociation()
{
}

void MaxAssociation::getIncidenceMatrix(const map<uint32_t, BaseObject*>& global_map, const vector<BaseObject*>& new_obj, Eigen::MatrixXd& incidence_matrix)
{
