...
namespace sensor_camera
{
	...
	public:
		...
		void getIncidenceMatrix(const map<uint32_t, sensor_camera::BaseObject*>& global_map, const vector<sensor_camera::BaseObject*>& new_obj, Eigen::MatrixXd& incidence_matrix);
