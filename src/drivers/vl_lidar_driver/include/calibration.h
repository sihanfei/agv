...
#ifndef __VELODYNE_POINTCLOUD_CALIBRATION_H
#define __VELODYNE_POINTCLOUD_CALIBRATION_H
...
public:
  ...
  Calibration(const std::string &calibration_file, bool info = true) : ros_info(info)
  {
