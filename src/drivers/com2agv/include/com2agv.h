...
// #define Test_TurnAngle  40      //unit: degree 转角测试标志，如果不需要请注释该行
// #define Test_StraightLength 50       //unit: m 直线测试标志，如果不需要请注释该行

#define SteerAngle_MAX 40		//unit: degree
#define ExpSpeed_MAX 4		    //unit: m/s
#define Freq_com2agv 50         //unit: HZ
#define Freq_pubstatus 5
#define VCU_timeout 100         //unit: ms
#define VCUCANChannel 1         //CAN channel change: 1~7
...
typedef enum
{
  ...
  VCU2C113  = 0x113,
  VCU2C_fl  = 0x18f120f0,      //extended frame
  VCU2C_fr  = 0x18f123f0,
  VCU2C_rl  = 0x18f126f0,
  VCU2C_rr  = 0x18f129f0
}AGV_FiltID;
