...
sleep 1s
{
    mate-terminal -t "planning_node" -x bash -c "rosrun planning planning_node 1;exec bash"
}&
...
sleep 1s
{
    mate-terminal -t "per_sender" -x bash -c "rosrun perception per_sender_pub 1 0;exec bash"
}&
...
#     --tab -t "map routing" -x bash -c "cd ~/work/superg_agv/src/routing/map_old/;python3 routing.py;exec bash"
# }&
