...
bool Box2d::HasOverlap(Box2d &box2d)
{
  ...
  for (uint32_t i = 0, j = vertexCount - 1; i < vertexCount + box2d.vertexCount; j = i, ++i)
  {
    ...
    else if (i < vertexCount)
    {
      ...
      // std::cout << "111111111..........." << "i=" << i << "..." << axis[i].x << "..." << axis[i].y << std::endl;
      if (calSqr(edge, axis) < 1.6e-6)
      {
        i = vertexCount - 1;
      }
    }
    else if (i == vertexCount)
    {
      ...
      axis = edge;
      // std::cout << "22222222222..........." << axis[i].x << "..." << axis[i].y << std::endl;
    }
    else
    {
      ...
      // std::cout << "33333333333..........." << axis[i].x << "..." << axis[i].y << std::endl;
    }
