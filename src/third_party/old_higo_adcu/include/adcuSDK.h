...
*/
int adcuDevRead(int DevId, uint8_t *buf);
...
/**
* @brief Set device options,only support RS232 now.  Return the number written, or -1.
* @param DevId : function adcuDevOpen() return value.
* @param buf : a point of buffer to write data.
* @param size : write size.
* @retval <=0 : write error.
* @retval >0 : the actual size of write. 
*/
int adcuDevSetOpt(int DevId,uint8_t *buf,int size);
